...
@objc open class ACFloatingTextfield: UITextField {
    ...
    @IBInspectable open var selectedLineColor : UIColor = UIColor(red: 19/256.0, green: 141/256.0, blue: 117/256.0, alpha: 0.5){
        didSet{
            self.floatTheLabel()
        }
    }
    ...
    @IBInspectable open var selectedPlaceHolderColor : UIColor = UIColor(red: 19/256.0, green: 141/256.0, blue: 117/256.0, alpha: 0.5){
        didSet{
            self.floatTheLabel()
        }
    }
...
fileprivate extension ACFloatingTextfield {
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder?.font = UIFont.init(name: (self.font?.fontName ?? "Montserrat-Light")!, size: 12)
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.font = UIFont(name: (self.font?.fontName ?? "Montserrat-Light")!, size: 12)
